                ...
                <div class="post-container">
                  ...
                  <?php
                      ...
                      $limit = 3;
                        ...
                        $sql = "SELECT post.post_id, post.title, post.description, post.post_date, category.category_name, post.author, user.username,post.post_img FROM post 
                     ...
                     if($total_page > $page){
                       echo '<li><a href="index.phpcid='.$cat_id .'&page='.($page + 1).'">Next</a></li>';
                     }
